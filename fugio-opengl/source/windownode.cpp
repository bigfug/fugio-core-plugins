...
bool WindowNode::initialise()
{
	...
	connect( mNode->context()->qobject(), SIGNAL(frameEnd(qint64)), this, SLOT(contextFrameEnd(qint64)) );
...
void WindowNode::contextFrameInitialise( qint64 pTimeStamp )
{
	if( mValOutputEvents )
	{
...
void WindowNode::contextFrameStart( qint64 pTimeStamp )
{
...
void WindowNode::contextFrameEnd( qint64 pTimeStamp )
{
