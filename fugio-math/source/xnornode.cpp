...
XnorNode::XnorNode( QSharedPointer<fugio::NodeInterface> pNode )
...
void XnorNode::inputsUpdated( qint64 pTimeStamp )
{
	Q_UNUSED( pTimeStamp )
...
QList<QUuid> XnorNode::pinAddTypesInput() const
{
...
bool XnorNode::canAcceptPin(fugio::PinInterface *pPin) const
{
