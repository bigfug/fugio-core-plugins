...
OrNode::OrNode( QSharedPointer<fugio::NodeInterface> pNode )
...
void OrNode::inputsUpdated( qint64 pTimeStamp )
{
...
QList<QUuid> OrNode::pinAddTypesInput() const
{
...
bool OrNode::canAcceptPin(fugio::PinInterface *pPin) const
{
